...
static const struct logger_stream_config gconfig[] = {
    ...
    {.type = LOGGER_STREAM_STDERR, .handler = {logger_stream_standard_create, logger_stream_standard_destroy, logger_stream_standard_error_flush}},
    {.type = LOGGER_STREAM_FILE, .handler = {logger_stream_file_create, logger_stream_file_destroy, logger_stream_file_flush}},
    {.type = LOGGER_STREAM_UDP, .handler = {logger_stream_socket_create, logger_stream_socket_destroy, logger_stream_socket_udp_flush}},
    {.type = LOGGER_STREAM_TCP, .handler = {logger_stream_socket_create, logger_stream_socket_destroy, logger_stream_socket_tcp_flush}},
    {.type = LOGGER_STREAM_DIRECT, .handler = {logger_stream_standard_create, logger_stream_standard_destroy, logger_stream_standard_output_flush}}};
