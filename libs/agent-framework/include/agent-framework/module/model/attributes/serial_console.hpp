...
class SerialConsole {
public:
    using SupportedConnections = agent_framework::model::attribute::Array<enums::SerialConsoleSupportedType>;
    ...
    friend auto operator<=>(const SerialConsole& lhs, const SerialConsole& rhs) = default;
