...
public:
    ...
    PowerManagementPolicy(const bool policy_enabled,
                          ...
                          const std::uint32_t peak_power_budget_milliwatts) : m_policy_enabled{policy_enabled},
    ...
    friend auto operator<=>(const PowerManagementPolicy& lhs, const PowerManagementPolicy& rhs) = default;
