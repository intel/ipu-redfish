...
public:
    ...
    CalculationParameters(const std::string& source_metric,
                          const std::string& result_metric) : m_source_metric{source_metric}, m_result_metric{result_metric} {}
    ...
    friend auto operator<=>(const CalculationParameters& lhs, const CalculationParameters& rhs) = default;
