...
public:
    ...
    friend auto operator<=>(const Drive& lhs, const Drive& rhs) = default;
     ...
     * */
    const OptionalField<double>& get_capable_speed_gbps() const {
        return m_capable_speed_gbps;
    }

    /*!
     * Sets drive capable speed in gigabytes per second
     * @param[in] capable_speed_gbps Drive's capable speed in gigabytes per second
     * */
    void set_capable_speed_gbps(const OptionalField<double>& capable_speed_gbps) {
        m_capable_speed_gbps = capable_speed_gbps;
    }
     ...
     * */
    const OptionalField<double>& get_negotiated_speed_gbps() const {
        return m_negotiated_speed_gbps;
    }

    /*!
     * Sets drive negotiated speed in gigabytes per second
     * @param[in] negotiated_speed_gbps Drive's negotiated speed in gigabytes per second
     * */
    void set_negotiated_speed_gbps(const OptionalField<double>& negotiated_speed_gbps) {
        m_negotiated_speed_gbps = negotiated_speed_gbps;
    }
...
private:
    ...
    OptionalField<double> m_capable_speed_gbps{};
    OptionalField<double> m_negotiated_speed_gbps{};
