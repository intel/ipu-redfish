 ...
 *
 */
ENUM(SystemType, uint32_t, Physical, Virtual, OS, PhysicallyPartitioned, VirtuallyPartitioned, Composed, DPU);
...
ENUM(BootOverrideTarget, uint32_t, None, Pxe, Floppy, Cd, Usb, Hdd, BiosSetup,
     Utilities, Diags, UefiShell, UefiTarget, SDCard, UefiHttp, RemoteDrive);
