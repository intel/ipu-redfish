...
public:
     ...
     * */
    explicit InvalidValue(const std::string& msg) : GamiException(ErrorCode::INVALID_VALUE, msg) {}
...
protected:
     ...
     * @param[in] msg error message
     * */
    explicit InvalidValue(const ErrorCode error_code, const std::string& msg) : GamiException(error_code, msg) {}
};
