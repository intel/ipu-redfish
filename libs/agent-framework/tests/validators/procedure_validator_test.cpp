...
#include "agent-framework/validators/checkers/regular_expressions.hpp"
...
ValidatorTester::ValidatorTester(const ProcedureValidator& _procedure, const json::Json& _json) : procedure(&_procedure),
                                                                                                  value(_json) {
}

ValidatorTester::ValidatorTester(const ProcedureValidator& _procedure, const char* _json) : procedure(&_procedure),
                                                                                            json(_json) {
}
