...
TEST_F(OptionalFieldTest, DefaultConstructionToNullValue) {
    ...
    ASSERT_THROW(OptionalField<int>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<unsigned int>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<int64_t>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<uint64_t>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<double>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<const char*>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<string>().value(), bad_optional_access);
    ASSERT_THROW(OptionalField<bool>().value(), bad_optional_access);
}
...
TEST_F(OptionalFieldTest, RpcJsonNullValueConversion) {
    ...
    ASSERT_THROW(int_opfield.value(), bad_optional_access);
    ASSERT_THROW(uint_opfield.value(), bad_optional_access);
    ASSERT_THROW(double_opfield.value(), bad_optional_access);
    ASSERT_THROW(cstring_opfield.value(), bad_optional_access);
    ASSERT_THROW(string_opfield.value(), bad_optional_access);
    ASSERT_THROW(bool_opfield.value(), bad_optional_access);
}
...
TEST_F(OptionalFieldTest, StringComparison) {
    ...
    ASSERT_EQ(not_set, nullopt);
    ASSERT_EQ(nullopt, not_set);
