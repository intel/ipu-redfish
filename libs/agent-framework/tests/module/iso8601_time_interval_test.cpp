...
TEST(Iso8601TimeInterval, compareOperators) {
    ...
    EXPECT_EQ(Iso8601TimeInterval::max(),
              Iso8601TimeInterval(hours(std::numeric_limits<int>::max()) + minutes(std::numeric_limits<int>::max()) + seconds(std::numeric_limits<int>::max()) + milliseconds(999)));
...
TEST(Iso8601TimeInterval, toString) {
    ...
    EXPECT_EQ("PT2147483647H2147483647M2147483647.999S", Iso8601TimeInterval(hours(std::numeric_limits<int>::max()) + minutes(std::numeric_limits<int>::max()) + seconds(std::numeric_limits<int>::max()) + milliseconds(999)).to_string());
}
