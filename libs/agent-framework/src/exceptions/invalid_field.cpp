...
InvalidField::InvalidField(const std::string& msg, const std::string& field_name, const json::Json& field_value) : GamiException(ErrorCode::INVALID_FIELD, msg, create_json_data_from_field(field_name, field_value)) {
}

InvalidField::InvalidField(const ErrorCode error_code, const std::string& msg, const json::Json& json_data) : GamiException(error_code, msg, json_data) {}
