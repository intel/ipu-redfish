...
MethodConflict::MethodConflict(const std::string& msg, const std::string& task_uuid) : GamiException(ErrorCode::METHOD_CONFLICT, msg, create_method_conflict_data(task_uuid)) {}
