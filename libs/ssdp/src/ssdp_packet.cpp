...
std::ostream& get_request_line(std::ostream& out, const SsdpPacket::Type& method) {
    ...
    if (SsdpPacket::Type::SEARCH_REQUEST == method || SsdpPacket::Type::NOTIFY == method) {
...
const std::array<const SsdpPacketTypeStrings, 4> ssdp_packet_type_strings_array = {{{SsdpPacket::Type::NOTIFY, "NOTIFY", "NOTIFY"},
