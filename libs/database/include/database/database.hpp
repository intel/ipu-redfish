...
public:
     ...
     */
    UuidKey(const std::string& _uuid) : uuid(_uuid),
                                        parent("") {}
     ...
     */
    UuidKey(const std::string& _uuid, const std::string& _parent) : uuid(_uuid),
                                                                    parent(_parent) {}
...
/*! @brief Representation of REST ID used by resources */
...
public:
    ...
    ResourceLastKey(const std::string& _parent) : parent(_parent),
                                                  resource("") {}
private:
