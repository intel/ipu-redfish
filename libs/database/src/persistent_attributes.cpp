 ...
 *
 * @file persistent_attributes.cpp
 */
...
UuidAttrKey::UuidAttrKey(const std::string& _uuid, const std::string& _attr) : attr(_attr), uuid(_uuid) {}
...
StringValue::StringValue(const std::string& _value) : value(_value) {}
