...
#       -Wmissing-include-dirs # gmock adds non-existent dir to include path
        -Wmissing-noreturn
        -Woverlength-strings
        -Wparentheses
        -Wpedantic
...
#        -Wstack-protector
    ...
    set(COMPILER_RELEASE    "-O3 -DNDEBUG -fdata-sections -ffunction-sections -s -flto=auto ${COMPILER_DEFENSES}")
    ...
    set(LINKER_DEBUG        "")
    set(LINKER_RELEASE      "-Wl,--gc-sections -s -flto=auto ${LINKER_DEFENSES}")
    ...
    if(CMAKE_GENERATOR STREQUAL "Unix Makefiles")
        ...
        add_definitions(-D__FILENAME__=\\"$\(subst .o,,$\(@F\)\)\\")
        cmake_policy(POP)
    endif()
