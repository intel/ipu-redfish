...
public:
    ...
    static const constexpr char INTERNAL_ERROR[] = "Base.1.18.InternalError";

    /*! @brief Indicates that the resource is in use. */
    static const constexpr char RESOURCE_IN_USE[] = "Base.1.18.ResourceInUse";

    /*! @brief Indicates that a general error has occurred. */
    static const constexpr char GENERAL_ERROR[] = "Base.1.18.GeneralError";

    /*! @brief Indicates that the request body was malformed JSON. Could be duplicate, syntax error, etc. */
    static const constexpr char MALFORMED_JSON[] = "Base.1.18.MalformedJSON";
    ...
    static const constexpr char RESOURCE_ALREADY_EXISTS[] = "Base.1.18.ResourceAlreadyExists";

    /*! @brief Indicates that the operation expected an image or other resource at the provided URI but none was found. */
    static const constexpr char RESOURCE_MISSING_AT_URI[] = "Base.1.18.ResourceMissingAtURI";

    /*! @brief Indicates that the attempt to access the resource/file/image at the URI was unauthorized. */
    static const constexpr char RESOURCE_AT_URI_UNAUTHORIZED[] = "Base.1.18.ResourceAtUriUnauthorized";
    ...
    static const constexpr char INSUFFICIENT_PRIVILEGE[] = "Base.1.18.InsufficientPrivilege";

    /*! @brief Indicates the service is temporarily unavailable. */
    static const constexpr char SERVICE_TEMPORARILY_UNAVAILABLE[] = "Base.1.18.ServiceTemporarilyUnavailable";

    /*! @brief Indicates that a duplicate property was included in the request body. */
    static const constexpr char PROPERTY_DUPLICATE[] = "Base.1.18.PropertyDuplicate";
    ...
    static const constexpr char PROPERTY_VALUE_TYPE_ERROR[] = "Base.1.18.PropertyValueTypeError";

    /*! @brief Indicates that an unknown property was included in the request body. */
    static const constexpr char PROPERTY_UNKNOWN[] = "Base.1.18.PropertyUnknown";

    /*! @brief Indicates that a required property was not supplied as part of the request. */
    static const constexpr char PROPERTY_MISSING[] = "Base.1.18.PropertyMissing";
    ...
    static const constexpr char PROPERTY_VALUE_NOT_IN_LIST[] = "Base.1.18.PropertyValueNotInList";
    ...
    static const constexpr char PROPERTY_VALUE_FORMAT_ERROR[] = "Base.1.18.PropertyValueFormatError";

    /*! @brief Indicates that the action supplied with the `POST` operation is not supported by the resource. */
    static const constexpr char ACTION_NOT_SUPPORTED[] = "Base.1.18.ActionNotSupported";

    /*! @brief Indicates that the url supplied with the `POST` operation is too long. */
    static const constexpr char INVALID_URI[] = "Base.1.18.InvalidURI";

    /*! @brief Indicates that the payload supplied with the `POST` operation is too large. */
    static const constexpr char PAYLOAD_TOO_LARGE[] = "Base.1.18.PayloadTooLarge";
    ...
    ServerError& operator=(ServerError&&) = default;
