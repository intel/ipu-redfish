...
public:
    ...
    /*!
     * @brief Create Redfish-defined error for action not supported.
     * @param[in] action Action name.
     * @param[in] custom_resolution Optional custom resolution message.
     * @return Action not supported error object.
     * */
    static ServerError create_action_not_supported_error(const std::string& action, const std::string& custom_resolution = {});

    /*!
     * @brief Create Redfish-defined error with HTTP status 414 uri too long.
     * @param[in] uri.
     * @return Uri_too_long error object.
     * */
    static ServerError create_uri_too_long_error(const std::string& uri);

    /*!
     * @brief Create Redfish-defined error for payload too large error.
     * @return Payload_too_large error object.
     * */
    static ServerError create_payload_too_large_error();
