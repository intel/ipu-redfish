...
# adds include <file> of $2 library to $1 file
function ADD_INCLUDE {
    printf "#include <$2>\n" >> $1
}

# adds include "file" of $2 library to $1 file
function ADD_INCLUDE_LOCAL {
    printf "#include \"$2\"\n" >> $1
}
...
ADD_INCLUDE $MAP_INITIALIZER "string"
ADD_INCLUDE_LOCAL $MAP_INITIALIZER "generated_headers.hpp"
