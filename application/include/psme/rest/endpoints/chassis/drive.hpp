...
/*!
 * A class representing the rest api Drive endpoint
 */
class Drive : public EndpointBase {
public:
    /*!
     * @brief The constructor for Drive endpoint
     */
    explicit Drive(const std::string& path);

    /*!
     * @brief Drive class destructor
     */
    virtual ~Drive();
