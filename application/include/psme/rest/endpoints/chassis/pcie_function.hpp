...
/*!
 * A class representing the rest api PcieFunction endpoint
 */
class PcieFunction : public EndpointBase {
public:
    /*!
     * @brief Constructor
     */
    explicit PcieFunction(const std::string& path);

    /*!
     * @brief PcieFunction class destructor
     */
    virtual ~PcieFunction();
