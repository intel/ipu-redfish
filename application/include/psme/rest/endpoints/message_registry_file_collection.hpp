 ...
 * */
class MessageRegistryFileCollection : public EndpointBase {
public:
    /*!
     * @brief Class constructor
     * */
    explicit MessageRegistryFileCollection(const std::string& path);

    /*!
     * @brief Class destructor
     * */
    virtual ~MessageRegistryFileCollection();
