...
/*!
 * A class representing the rest api Manager endpoint
 */
class Manager : public EndpointBase {
public:
    /*!
     * @brief The constructor for Manager class
     */
    explicit Manager(const std::string& path);

    /*!
     * @brief Manager class destructor
     */
    virtual ~Manager();
