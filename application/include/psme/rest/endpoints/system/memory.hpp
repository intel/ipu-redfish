...
/*!
 * A class representing the rest api DimmConfig endpoint
 */
class Memory : public EndpointBase {
public:
    /*!
     * @brief The constructor for Memory class
     */
    explicit Memory(const std::string& path);

    /*!
     * @brief Memory class destructor
     */
    virtual ~Memory();
