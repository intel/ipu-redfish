...
json::Json make_prototype() {
    ...
    r[Common::ODATA_TYPE] = "#ActionInfo.v1_4_2.ActionInfo";

    r[Common::ID] = "SimpleUpdateActionInfo";
    r[Common::NAME] = "Simple Update Action Info";
    r[Common::DESCRIPTION] = "Simple Update Action Info";
...
void endpoint::SimpleUpdateActionInfo::get(const server::Request& request, server::Response& response) {
    ...
    // targets[ActionInfo::DATA_TYPE] = "StringArray";
