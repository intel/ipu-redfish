...
json::Json make_prototype() {
    ...
    r[Common::ODATA_CONTEXT] = "/redfish/v1/$metadata#MemoryCollection.MemoryCollection";
...
void MemoryCollection::get(const server::Request& req, server::Response& res) {
    ...
    auto keys = agent_framework::module::ComputeComponents::get_instance()->get_memory_manager().get_ids(system_uuid);
