...
System make_system(const std::string& parent, const std::string& uuid) {
    ...
    system.set_status({agent_framework::model::enums::State::Enabled,
                       agent_framework::model::enums::Health::OK});
...
Processor make_processor(const std::string& parent, const std::string& uuid) {
    ...
    processor.set_manufacturer("Intel Corporation");
    ...
    processor.set_status({agent_framework::model::enums::State::Enabled,
                          agent_framework::model::enums::Health::OK});
    return processor;
}
} // namespace
